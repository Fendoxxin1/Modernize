...
const Products = () => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (res.status === 201 || res.status === 200) {
                ...
                const updatedData = await axios.get(BaseURL);
    ...
    return (
        <div className="p-8 w-full bg-white rounded-2xl shadow-sm border border-gray-100">
            {addProduct ? (
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-gray-100">
                                    <th className="pb-4 font-semibold text-gray-500 text-sm w-[40%]">Product</th>
                                    ...
                                    <th className="pb-4 font-semibold text-gray-500 text-sm text-right">Rating</th>
                                </tr>
                            </thead>
                                ...
                                {data?.map((item) => (
                                    <tr key={item} className="hover:bg-gray-50/50 ">
                                        <td className="py-4 flex items-center gap-4">
                                            ...
                                            />
                                            <span className="font-medium text-gray-800">{item.producName}</span>
                                        </td>
                                        ...
                                        <td className="py-4 text-right text-gray-500 text-sm">5.0 (32 Votes)</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
